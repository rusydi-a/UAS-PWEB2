...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-sm-4">
                    <h1 class="my-4">Input Logistik Pemasok</h1>
                    <div class="card mb-4">
                        <div
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning mb-1" data-bs-toggle="modal"
                                                data-bs-target="#edit<?php echo $item['idmasuk']; ?>">
                                                Edit
                                            </button>
                                    ...
                                    <div class="modal fade" id="edit<?php echo $item['idmasuk']; ?>" tabindex="-1"
    ...
    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Input Logistik</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="tambah_barang_masuk-supplier.php">
                    <div class="modal-body">
