...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-sm-4">
                    <h1 class="my-4">Logistik Pengiriman</h1>
                    <div class="card mb-4">
                        <div
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-striped">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <button type="button" class="btn btn-warning mb-1 me-2"
                                                    ...
                                                    data-bs-target="#edit<?php echo $item['idkeluar']; ?>">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-danger mb-1"
                                                    style="width: 75px; height: 40px;" data-bs-toggle="modal"
                                                    data-bs-target="#hapus<?php echo $item['idkeluar']; ?>">
                                                    Hapus
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <div class="modal fade" id="edit<?php echo $item['idkeluar']; ?>" tabindex="-1"
                                                ...
                                                <form method="POST" action="edit_barang_keluar.php">
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="hidden" name="idkeluar"
                                                            value="<?php echo $item['idkeluar']; ?>">
                                                        <label class="mb-1">Jumlah barang :</label>
                                                        <input type="text" name="qty"
                                                            value="<?php echo $item['qty']; ?>" min="1"
                                                            class="form-control mb-3" required />
                                                        <label class="mb-1">Nama Toko/Usaha Penerima :</label>
                                                        <input type="text" name="penerima"
                                                            value="<?php echo $item['penerima']; ?>"
                                                            class="form-control mb-3" required />
                                                    </div>
                                    ...
                                    <div class="modal fade" id="hapus<?php echo $item['idkeluar']; ?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
    ...
    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Input Data Logistik Pengiriman</h5>
                ...
                <form method="POST" action="tambah_barang_keluar.php">
                    <div class="modal-body">
                        <select name="barang" class="form-control mb-3">
                            ...
                            <option value="<?php echo $item['idbarang']; ?>">
                                <?php echo $item['namabarang']; ?>
                            </option>
                            <?php endforeach ?>
                        </select>
                        <input type="number" name="qty" placeholder="Jumlah barang" min="1" class="form-control mb-3"
                            required />
                        <input type="text" name="penerima" placeholder="Toko/Usaha Penerima" class="form-control mb-3"
                            required />
                    </div>
                    <div class="modal-footer">
