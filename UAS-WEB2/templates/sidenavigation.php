...
<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav mt-3">
                <!-- Tautan ke halaman 'index.php' -->
                <a class="nav-link" href="index.php">
                    <div class="sb-nav-link-icon <?php echo strpos($_SERVER['REQUEST_URI'], 'admin_dashboard') ? 'text-primary' : ''; ?>">
                        <i class="fa-solid fa-layer-group"></i>
                    </div>
                    Penyimpanan Logistik
                </a>
                <!-- Tautan ke halaman 'barang_masuk.php' -->
                <a class="nav-link" href="barang_masuk.php">
                    <div class="sb-nav-link-icon <?php echo strpos($_SERVER['REQUEST_URI'], 'barang_masuk') ? 'text-primary' : ''; ?>">
                        <i class="fa-solid fa-circle-plus"></i>
                    </div>
                    Logistik Penerimaan
                </a>
                <!-- Tautan ke halaman 'barang_keluar.php' -->
                <a class="nav-link" href="barang_keluar.php">
                    <div class="sb-nav-link-icon <?php echo strpos($_SERVER['REQUEST_URI'], 'barang_keluar') ? 'text-primary' : ''; ?>">
                        <i class="fa-solid fa-circle-minus"></i>
                    </div>
                    Logistik Pengiriman
                </a>
                <!-- Tautan ke halaman 'datauser.php' -->
                <a class="nav-link" href="datauser.php">
                    <div class="sb-nav-link-icon <?php echo strpos($_SERVER['REQUEST_URI'], 'datauser') ? 'text-primary' : ''; ?>">
                        <i class="fa-solid fa-user-edit"></i>
                    </div>
                    Data User
                </a>
                <!-- Tautan ke halaman 'logout.php' -->
 ...
 <div class="sb-sidenav-footer">
            ...
            if ($result) {
                ...
                echo '<div class="small">Login sebagai: ' . $_SESSION['email'] . '</div>';
            }
            ?>
        </div>
    </nav>
