        ...
        <div class="sb-sidenav-menu">
            <div class="nav mt-3">
                <a class="nav-link" href="index.php">
                    <div class="sb-nav-link-icon <?php echo strpos($_SERVER['REQUEST_URI'], 'supplier_dashboard') ? 'text-primary' : ''; ?>"><i class="fa-solid fa-layer-group"></i></div>
                    Penyimpanan Logistik
                </a>
                <a class="nav-link" href="barang_masuk-supplier.php">
 ...
 <div class="sb-sidenav-footer">
            ...
            if ($result) {
                ...
                if (!empty($foto)) {
                    ...
                    echo '<a href="profil-supplier.php">';
