...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <?php require 'templates/sidenavigation-pimpinan.php'; ?>

        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-sm-4">
                    <h1 class="my-4">Laporan Penyimpanan Logistik</h1>
                    <div class="card mb-4">
                        <div
                            ...
                            <div>
                                <button type="button" class="btn btn-success"
                                    onclick="window.open('exportstkbhn.php', '_blank')">
                            ...
                            <table id="datatablesSimple" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="detail_barang.php?id=<?php echo $item['idbarang']; ?>"></a>
                                    </tr>
