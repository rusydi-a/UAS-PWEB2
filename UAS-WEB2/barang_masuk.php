                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-striped">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <button type="button" class="btn btn-danger mb-1"
                                                    ...
                                                    data-bs-target="#hapus<?php echo $item['idmasuk']; ?>">
                                                    Hapus
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <div class="modal fade" id="hapus<?php echo $item['idmasuk']; ?>" tabindex="-1"
